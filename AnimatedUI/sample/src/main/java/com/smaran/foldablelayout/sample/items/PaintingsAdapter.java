package com.smaran.foldablelayout.sample.items;
...
import com.smaran.foldablelayout.sample.activities.UnfoldableDetailsActivity;
...
public class PaintingsAdapter extends ItemsAdapter<Painting> implements View.OnClickListener {
    ...
    protected View createView(Painting item, int pos, ViewGroup parent, LayoutInflater inflater) {
        View view = LayoutInflater.from(parent.getContext()).inflate(com.smaran.foldablelayout.sample.R.layout.list_item, parent, false);
        ViewHolder vh = new ViewHolder();
        vh.image = Views.find(view, com.smaran.foldablelayout.sample.R.id.list_item_image);
        vh.image.setOnClickListener(this);
        vh.title = Views.find(view, com.smaran.foldablelayout.sample.R.id.list_item_title);
        view.setTag(vh);
